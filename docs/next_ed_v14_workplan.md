...
|---|---|---|
| Untouched confirmation dataset | Outcome-blind protocol locked; pinned FACED v1.1.3 data ingested; all prespecified analyses reported | Access-only amendment locked; 123/123 participants passed header/event structural preflight; checksummed metadata/events acquired outside repository; 31.4 GiB BDF acquisition and signal QC in progress |
