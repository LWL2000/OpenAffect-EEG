...
|---|---|---|
| Untouched confirmation dataset | Outcome-blind protocol locked; pinned FACED v1.1.3 data ingested; all prespecified analyses reported | Access-only amendment locked; 618 source files (31.41 GiB) checksummed outside repository; 123 participants and 3,444 trials passed outcome-blind QC and frozen ingestion with no exclusions; experiment assignments and models remain |
