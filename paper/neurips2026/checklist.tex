...
\item {\bf Open access to data and code}
    ...
    \item[] Answer: \answerYes{}
    \item[] Justification: The anonymous artifact provides code, configurations, aggregate results, metadata, and documented synthetic and source-linked verification commands. Unauthenticated access and file hashes were checked against the final release. Source recordings remain with their original providers and must be obtained under their terms. The independent clean-install check establishes artifact execution, not third-party raw-to-paper reproduction.
...
\item {\bf Experiment statistical significance}
    ...
    \item[] Answer: \answerYes{}
    \item[] Justification: The Results and diagnostics appendix define the paired estimand, shared crossed-identity resampling, invalid draws, fixed-fit scope, and sensitivity methods. Topology-matched simulations support the primary five-block uniform-mean interval; failed cellwise calibration is disclosed, so cell ranges are descriptive and no equivalence or unconditional retraining claim is made.
