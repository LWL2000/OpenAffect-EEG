...
\item {\bf Open access to data and code}
    ...
    \item[] Justification: Code, configurations, aggregates, metadata, and synthetic commands exist in a versioned public release. Unauthenticated access to the anonymous code entry and key files was verified on 9 September 2026. Full raw-to-model reproduction and synchronization of the new revision with that endpoint have not been independently verified, so this working revision retains No. Source recordings remain with their original providers.
...
\item {\bf Experiment statistical significance}
    ...
    \item[] Answer: \answerYes{}
    \item[] Justification: The Results and new diagnostics appendix define shared crossed-identity intervals, invalid draws, fixed-fit uncertainty, and heuristic sensitivity; the five-block study exposes serious undercoverage, so no calibrated significance or equivalence claim is made. Historical seed sign-flip tests are separately labelled and are not independent study replication.
...
\item {\bf New assets}
    ...
    \item[] Answer: \answerYes{}
    \item[] Justification: The prepared release contains data/model/evaluation cards, Croissant metadata, protocol status, limitations, and reproducibility modes. Anonymous access to key files has been verified; matching the online artifact to this revised manuscript remains a separate version check.
